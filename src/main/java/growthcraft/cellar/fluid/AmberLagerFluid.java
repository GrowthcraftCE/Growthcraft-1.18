...
import static growthcraft.cellar.shared.Reference.FluidColor.AMBER_LAGER_FLUID_COLOR;
...
public class AmberLagerFluid extends ForgeFlowingFluid {
    ...
    private static final ColorUtils.GrowthcraftColor color = AMBER_LAGER_FLUID_COLOR;
